...
def frontdesk_authenticate():
    ...
    query = "SELECT * FROM frontdeskop WHERE username = %s AND password = %s"
...
def dataentryop_authenticate():
    username = request.form['username']
    password = request.form['password']
    query = "SELECT * FROM dataentryop WHERE username = %s AND password = %s"
    params = (username, password)
    result = execute_query(conn, query, params)
    if result:
...
def doctor_authenticate():
    username = request.form['username']
    password = request.form['password']
    query = "SELECT * FROM doctor WHERE name = %s AND password = %s"
    params = (username, password)
    result = execute_query(conn, query, params)
    if result:
